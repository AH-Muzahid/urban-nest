                            ...
                            <div className="flex items-center gap-4">
                                {compareList.map((item) => (
                                    <div key={item._id} className="relative group shrink-0">
                                        <div className="size-12 rounded-lg bg-cover bg-center border border-gray-200 dark:border-gray-700" style={{ backgroundImage: `url('${item.images?.[0] || '/placeholder.jpg'}')` }} />
                                        <button
