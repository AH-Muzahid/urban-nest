                            ...
                            <Link href={category.href} className="block w-full h-full relative min-h-[300px] md:min-h-0">
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-8">
                                    <div>
                                        ...
                                        <h3 className="text-white text-3xl font-black uppercase tracking-tight leading-none transition-colors">{category.title}</h3>
                                    </div>
                                </div>
                            </Link>
                        </motion.div>
